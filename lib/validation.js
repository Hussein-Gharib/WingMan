    ...
    instagram_url: z
      .union([
        ...
        z
          ...
          // Only http(s) — this value is rendered into an <a href> on the public
          // site, so block javascript:, data:, and other active schemes.
          .refine((v) => /^https?:\/\//i.test(v), 'Instagram URL must start with http(s)://'),
      ])
      .default(''),
